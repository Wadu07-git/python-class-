...
# print(laptops)
# removed = laptops.pop(4) #gives removed item present at the given index and also removes item 
# print(removed)
# print(laptops)
...
# count = a.count(1) #gives count of given item in tuple
# print(count)
# print(a.index(1)) #gives indexing number of given item in tuple
